...
def parse_officials(report_html):
    ...
    for role_text, role_name in role_map.items():
        role_span = soup.find(
            "span",
            string=lambda value:
                value and value.strip() == role_text
        )
...
COMPETITIONS_2024 = [
    {
        "id": 190139,
        "name": "3. deild karla 2024",
        "gender": "Male",
        "type": "Deild",
    },
    {
        "id": 190138,
        "name": "4. deild karla 2024",
        "gender": "Male",
        "type": "Deild",
    },
]
    ...
    for page_html in all_html_pages:
        ...
        for link in match_links:
            ...
            card = link.find_parent(
                "div",
                class_=lambda value:
                    value and "grid-cols-[70%_auto]" in value
            )
...
with open(
    "data/archive-2024-lower-test.json",
    "w",
    encoding="utf-8"
) as file:
    json.dump(
...
print(
    ...
    f"to data/archive-2024-lower-test.json"
)